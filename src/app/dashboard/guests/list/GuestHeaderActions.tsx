...
import { GuestFilterQuery, GuestQueryprops } from "../model/guest.model";

const GuestHeaderActions: FC<GuestQueryprops> = ({ handleFilter }) => {
  const [query, setQuery] = useState<GuestFilterQuery | null>(null);
