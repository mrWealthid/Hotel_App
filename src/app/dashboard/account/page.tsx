...
const Page = () => {
  ...
  return (
    <section className="">
      ...
      <section className="flex dark:text-secondary text-primary lg:flex-row flex-col w-full animate-slideIn   gap-3 ">
        ...
        <AccountForm data={data} stage={stage} updateStage={updateStage} />
      </section>
    </section>
  );
};
