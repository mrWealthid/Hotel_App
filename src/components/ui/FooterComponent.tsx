...
import TextInput from "../shared/form-elements/Text-Input";
import EmailInput from "../shared/form-elements/Email-Input";
    ...
    <footer className=" flex text-secondary flex-col ">
      <section className=" background py-10 md:py-12 flex flex-col text-center items-center gap-3 justify-center container-text ">
        ...
        >
          <p className="md:max-w-2xl text- font-light 2xl:max-w-2xl">
            ...
            itaque, eum iure a, veritatis ipsa placeat enim vel voluptatem
            tempore id dolore officia. Eum, magnam cum! Perferendis, distinctio
            laborum? tenetur itaque, eum iure a, veritatis ipsa placeat enim vel
            voluptatem tempore id dolore officia. Eum, magnam cum! Perferendis,
            distinctio laborum?
          </p>
        </Reveal>
        ...
        "
        >
          <TextInput name={"FullName"} placeholder={"Enter Full Name"} />

          <section className="flex w-full gap-3">
            <EmailInput name={"email"} />

            <TextInput name={"Phone"} placeholder={"Enter Phone Number"} />
          </section>
      ...
      <section className="pb-0 bg-primary-300  container-text text-secondary md:pb-10">
        <div className="pt-8 md:pt-16 flex-wrap flex flex-col md:flex-row justify-between">
          ...
          <div className="mt-5">
            <p className="text-xs md:text-sm font-medium">Quick Links</p>
            <a href="/" className="block text-xs md:text-sm cursor-pointer">
              Dashboard
            </a>
            <a href="/" className="block text-xs md:text-sm cursor-pointer">
              Login
          ...
          <div className="mt-5">
            <p className="font-medium text-sm md:text-sm">Get In Touch</p>
